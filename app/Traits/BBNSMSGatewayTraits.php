...
trait BBNSMSGatewayTraits{
	...
	static $BROADCAST_URL_V2 = 'http://gateway.sms.bbnplace.com/api/sendtext.php';
	static $BROADCAST_URL = 'https://www.bbnplace.com/sms/bulksms/bulksms.php';
	static $BALANCE_URL = 'https://www.bbnplace.com/sms/bulksms/acctbals.php';
	static $LOGIN_TRIAL = 'https://www.bbnplace.com/sms/bulksms/login.php';
	static $DLR_URL = 'http://gateway.sms.bbnplace.com/api/dlreport.php';

	public function __construct($config = array('appid'=>'271519','callback'=>1)) {
		if (count ( $config ) > 0) {
