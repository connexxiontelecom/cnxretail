        ...
        <div class="row">
            <div class="col-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Payment Integration</a>
                </div>
            </div>
            <div class="col-9">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-12 col-md-12">
                                                    <div class="form-group form-primary form-static-label">
                                                        <input type="text" name="sender_id" id="sender_id" value="{{old('sender_id', Auth::user()->tenant->sender_id)}}" class="form-control">
                                                        <span class="form-bar"></span>
                                                        <label class="float-label">Bulk SMS Sender ID</label>
                                                    </div>
                                                <div class="form-group form-primary form-static-label">
