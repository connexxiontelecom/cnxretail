...
@section('page-description')
    A list of files and folders in {{$directory->name ?? ''}}
@endsection
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        <hr>
        <div class="row">
            @foreach ($folders->where('parent_id', $directory->id) as $folder)
            ...
            @endforeach
            @foreach ($files->where('folder_id', $directory->id) as $file)
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="createFolderForm" class="form-material">
            ...
            <input type="hidden" name="parent_folder" value="{{$directory->id}}">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="uploadFileForm" class="form-material">
            ...
            <input type="hidden" name="folder" value="{{$directory->id}}" class="form-control">
            <div class="form-group d-flex justify-content-center">
                <button type="button" class="btn btn-secondary btn-mini" data-dismiss="modal">Close</button>
