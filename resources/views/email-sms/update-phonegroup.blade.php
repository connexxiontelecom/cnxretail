        ...
        <div class="row">
            <div class="col-md-4 col-sm-4">
                <form class="form-material" id="phoneGroupForm">
                    ...
                    <input type="hidden" name="groupName" value="{{$group->id}}">
                    <div class="form-group form-primary form-static-label">
                        <textarea name="phone_numbers" class="form-control" cols="30" rows="10">{{$group->phone_numbers}}</textarea>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            <div class="btn-group d-flex justify-content-center">
                                ...
                                <button type="submit"  class="btn btn-primary btn-mini save-contact"> <i class="ti-check mr-2"></i> Update Phone Group</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    $(document).ready(function(){
        ...
        phoneGroupForm.onsubmit = async (e) => {
                e.preventDefault();
                axios.post('/update-phonegroup',new FormData(phoneGroupForm))
                .then(response=>{
                    Toastify({
